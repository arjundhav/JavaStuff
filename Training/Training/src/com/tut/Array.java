...
public class Array {
	...
	public static void main(String[] args) {
		//int[] arr = new int[]
		int a[]={2,4,6,8,10};
		System.out.println(a[1]); //access element by index value
    ...
    //System.arraycopy(source,0,destination,1,5)
		int c[]= {1,2,3,4,5};
		int d[] = {9,8,7,4,6};
		System.arraycopy(d,0,c,1, 3);
		System.out.println("After copying value at index 1 of c: "+c[1]+"\n");
		
		
	// Copying the element from one array to another	
		int p[] = { 3, 8, 3 };
		int q[] = new int[a.length];   //Create an array b[] of same size as a[]

	    q = p;       // Doesn't copy elements of a[] to b[], only makes b refer to same location
	
	    q[0]++;  // Change to b[] will also reflect in a[], as 'a' and 'b' refer to same location.
